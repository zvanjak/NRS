...
void Demo_Real_function_serialization()
{
    ...
    auto ret1 = std::system("..\\..\\tools\\visualizers\\real_function_visualizer\\NRS_RealFunctionVisualizer.exe ..\\..\\results\\func_sin_x_x.txt");
}
...
void Demo_Scalar_function_2D_serialization()
{
    ...
    auto ret2 = std::system("..\\..\\tools\\visualizers\\scalar_function_2d_visualizer\\NRS_ScalarFunction2Visualizer.exe ..\\..\\results\\func_cart_2d.txt");
}
...
void Demo_Parametric_curve_serialization()
{
    ...
    // std::system("..\\..\\tools\\visualizers\\parametric_curve_visualizer\\NRS_ParametricCurveVisualizer.exe helix.txt");

    Serializer::SaveParamCurveCartesian3D(toroid, "Toroid", 0.0, 5.0 * Constants::PI, 500, "..\\..\\results\\toroid.txt");
    auto ret = std::system("..\\..\\tools\\visualizers\\parametric_curve_visualizer\\NRS_ParametricCurveVisualizer.exe ..\\..\\results\\toroid.txt");
}
...
void Demo_Vector_field_serialization()
{
    ...
    auto ret2 = std::system("..\\..\\tools\\visualizers\\vector_field_visualizer\\NRS_VectorFieldVisualizer.exe ..\\..\\results\\vector_field.txt");
    ...
    auto ret3 = std::system("..\\..\\tools\\visualizers\\vector_field_visualizer\\NRS_VectorFieldVisualizer.exe ..\\..\\results\\vector_field_spherical.txt");
