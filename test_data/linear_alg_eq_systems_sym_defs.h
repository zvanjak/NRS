#if !defined NRS_LINEAR_ALG_EQ_SYSTEMS_SYM_DEFS_H
#define NRS_LINEAR_ALG_EQ_SYSTEMS_SYM_DEFS_H
...
namespace NRS::TestBeds
{
	...
	/***********************************************************************************************/
	const static inline NRS::MatrixSym<Real>  symm_mat_3x3{ 3, { 7.9, -9.3,  1.7,
																																	 -5.9,  9.9,
																																				 -5.5 } };
	...
	const static inline NRS::MatrixSym<Real>  symm_mat_3x3_1{ 3, { 2, -1,  0,
																																		2, -1,
																																				2 } };
	...
	/***********************************************************************************************/
	const static inline NRS::MatrixSym<Real>  symm_mat_5x5{ 5,  {1.4, 2.1, 2.1, 7.4, 9.6,
																																	 1.5, 1.1, 0.7, 5.0,
																																				9.6, 5.4, 8.8,
																																						 0.4, 8.0,
																																									7.7 } };
...
#endif // NRS_LINEAR_ALG_EQ_SYSTEMS_SYM_DEFS_H